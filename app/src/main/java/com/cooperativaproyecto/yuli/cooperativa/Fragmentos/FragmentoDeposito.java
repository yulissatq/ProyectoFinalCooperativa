 ...
 * {@link FragmentoDeposito.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FragmentoDeposito#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentoDeposito extends Fragment {
     ...
     * @return A new instance of fragment FragmentoDeposito.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentoDeposito newInstance(String param1, String param2) {
        FragmentoDeposito fragment = new FragmentoDeposito();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View vista=inflater.inflate(R.layout.fragment_fragmento_deposito, container, false);


        lblNumero = (TextView)vista.findViewById(R.id.lbl_numeroCuentaBusquedaDeposito);
        lblEstado=(TextView)vista.findViewById(R.id.lbl_estadoCuentaBusquedaDeposito);
        lblSaldo=(TextView)vista.findViewById(R.id.lbl_saldoCuentaBusquedaDeposito);
        lblTipoCuenta=(TextView)vista.findViewById(R.id.lbl_tipoCuentaBusquedaDeposito);
        searchView =(SearchView)vista.findViewById(R.id.search_busquedaCuentaDeposito);
        datosMonto =(RelativeLayout)vista.findViewById(R.id.datos_deposito);

        txtDescripcion=(EditText)vista.findViewById(R.id.txt_descripcionDeposito);


        regresar = (Button)vista.findViewById(R.id.btn_cancelarDeposito);
        ...
        lblMonto=(TextView)vista.findViewById(R.id.lbl_montoDeposito);
        txtMontoDepoditar=(EditText)vista.findViewById(R.id.txt_montoDeposito);
        btnDepositar=(Button)vista.findViewById(R.id.btn_depositar);

        datosMonto.setVisibility(View.INVISIBLE);

        //btn_cancelarDeposito
                                    ...
                                    btnDepositar.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            if(txtMontoDepoditar.getText().toString().equalsIgnoreCase("")|| txtDescripcion.getText().toString().equalsIgnoreCase("")){
                                                ...
                                                String urlDeposito = "http://"+ip.getIp()+"/ProyectoCooperativa/api/cuenta/deposito";
